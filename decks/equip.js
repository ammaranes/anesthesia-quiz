...
window.OFFICIAL_DECKS['equipment_answered'] = {
  ...
  questions: [
    {
      ...
      "options": [
        { "letter": "A", "text": "PETCO2 > 10 mmhg" },
        { "letter": "B", "text": "Patient temperature < 32 c" },
        { "letter": "C", "text": "Measured urine output of 1 ml/kg per hour" },
        { "letter": "D", "text": "Diastolic intra- arterial pressure <20 mmhg" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Vital capacity less than 40%" },
        { "letter": "B", "text": "DLCO2 less than 50" },
        { "letter": "C", "text": "FEV1 65%" },
        { "letter": "D", "text": "FVC 75%" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "stem": "Pulse oximeter :",
      "options": [
        { "letter": "A", "text": "Contain both red & infrared" },
        { "letter": "B", "text": "Wave length used 600-900" },
        { "letter": "C", "text": "Wave length used 800-900" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Fluorescent light" },
        { "letter": "B", "text": "Infrared light" },
        { "letter": "C", "text": "Surgical light" },
        { "letter": "D", "text": "Camera flash light" },
        { "letter": "E", "text": "Fibreoptic surgical light" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Hemoglobin S" },
        { "letter": "B", "text": "Hemoglobin F" },
        { "letter": "C", "text": "Methylene blue dye" },
        { "letter": "D", "text": "Fluroscene dye" },
        { "letter": "E", "text": "Carboxyhaemoglobin" }
      ],
      "correctAnswer": "E",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Left shift of the oxygen Hemoglobin dissociation curve" },
        { "letter": "B", "text": "Increase CO2 production" },
        { "letter": "C", "text": "Lactic acidosis" },
        { "letter": "D", "text": "Decreasing Pao2" },
        { "letter": "E", "text": "Producing methemoglobin" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        ...
        { "letter": "B", "text": "Convection" },
        { "letter": "C", "text": "Conduction" },
        { "letter": "D", "text": "Evaporation" }
      ],
      "correctAnswer": "B",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "It’s a red color." },
        { "letter": "B", "text": "It’s wave length is 500 nm." },
        { "letter": "C", "text": "Originated from solid emitter." },
        { "letter": "D", "text": "Cannot be transmitted through fiberoptic" }
      ],
      "correctAnswer": "D",
    ...
    },
    {
      ...
      "stem": "Regarding IOP :",
      "options": [
        { "letter": "A", "text": "Increase Po2 will decrease IOP" },
        { "letter": "B", "text": "Increase Po2 will increase IOP" },
        { "letter": "C", "text": "Increase Pco2 will increase IOP" },
        { "letter": "D", "text": "Decrease Pco2 will increase IOP" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Invasive arterial line is recommended" },
        { "letter": "B", "text": "Hypotensive anesthesia is good in this case" },
        { "letter": "C", "text": "Aim for hyperventilation to PaCO2 of 25 mmHg" },
        { "letter": "D", "text": "Optimal temperature is 32C" },
        { "letter": "E", "text": "Moderate sedation using propofol and remifentanil" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Aspiration Pneumonia" },
        { "letter": "B", "text": "Transfusion Related Acute Lung Injury (TRALI)" },
        { "letter": "C", "text": "Negative Pressure Pulmonary Edema" },
        { "letter": "D", "text": "Transfusion Associated Circulatory Overload (TACO)" }
      ],
      "correctAnswer": "B",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Patient alveolar ventilation" },
        { "letter": "B", "text": "2 × MV" },
        { "letter": "C", "text": "3 × MV" },
        { "letter": "D", "text": "4 × MV" },
        { "letter": "E", "text": "70 ml/kg/min" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Age" },
        { "letter": "B", "text": "Body Weight" },
        { "letter": "C", "text": "Tidal volume" },
        { "letter": "D", "text": "Minute volume" }
      ],
      "correctAnswer": "D",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Mapelson A FGF and APL close to pt" },
        { "letter": "B", "text": "Mapelson F has open bag and FGF is close to pt" },
        { "letter": "C", "text": "Mapelson D the FGF .APL and breathing bag close to pt" },
        { "letter": "D", "text": "Mapelson E something" }
      ],
      "correctAnswer": "B",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Fresh gas inflow directly into circle system" },
        { "letter": "B", "text": "The oxygen flush valve is entering the circle system at the fresh gas inlet" },
        { "letter": "C", "text": "The ventilator is delivering the prescribed tidal volume to the patient lungs" },
        { "letter": "D", "text": "The fresh gas inlet is delivered into reservoir bag by a valve that is located between the fresh gas source and ventilator circuit." }
      ],
      "correctAnswer": "D",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Metabolic Acidosis" },
        { "letter": "B", "text": "Hyperoxia" },
        { "letter": "C", "text": "Barbiturate" },
        { "letter": "D", "text": "one of the opioids" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "In GE Aisys machine, pressure system leakage is not measured" },
        { "letter": "B", "text": "Oxygen analyzer is least important monitors of the anesthesia ventilators" },
        { "letter": "C", "text": "A functioning self-inflating resuscitation bag is required even if anesthesia machine passed initial checkout time" },
        { "letter": "D", "text": "The ASA 2008 recommendation call for performing the breathing system test and leak test before" },
        { "letter": "E", "text": "Starting once a week" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "O2 analyzer" },
        { "letter": "B", "text": "CO2 analyzer" },
        { "letter": "C", "text": "Cuff leak" },
        { "letter": "D", "text": "O ring" }
      ],
      "correctAnswer": "D",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Close the pop-off valve, occlude the Y-piece, pressure the circuit to 50 cm water" },
        { "letter": "B", "text": "Close the pop-off valve, occlude the Y-piece, pressure the circuit to 30 cm water" },
        { "letter": "C", "text": "Close the pop-off valve, occlude the Y-piece, pressure the circuit to 100 cm water" },
        { "letter": "D", "text": "Remove the Y-piece, breath through the two corrugated hoses individually, the valve should present and move appropriately" }
      ],
      "correctAnswer": "B",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Muscle spasm" },
        { "letter": "B", "text": "Hyperthermia" },
        { "letter": "C", "text": "Increase EtCO2" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Hypoperfusion" },
        { "letter": "B", "text": "Diffusion abnormality" },
        { "letter": "C", "text": "Ventilation perfusion mismatch" },
        { "letter": "D", "text": "Shunt" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Dead space" },
        { "letter": "B", "text": "Diffusion abnormality" },
        { "letter": "C", "text": "Shunt" },
        { "letter": "D", "text": "Hypoperfusion syndrome" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Shunt" },
        { "letter": "B", "text": "Hypoventilation" },
        { "letter": "C", "text": "Ventilation perfusion mismatch" },
        { "letter": "D", "text": "Membrane damage" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Shunt" },
        { "letter": "B", "text": "Hypoventilation" },
        { "letter": "C", "text": "Diffusion impairment" },
        { "letter": "D", "text": "Ventilation / Perfusion mismatch" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Shunt" },
        { "letter": "B", "text": "V-Q mismatching" },
        { "letter": "C", "text": "Increase production of carbon monoxide" },
        { "letter": "D", "text": "Alteration of fluid-gas gradient" },
        { "letter": "E", "text": "Increased dead space" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Seizure" },
        { "letter": "B", "text": "Poor sampling spine" },
        { "letter": "C", "text": "Leaking from the tube" },
        { "letter": "D", "text": "Pulmonary hypoperfusion" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "PE" },
        { "letter": "B", "text": "Poor sampling" },
        { "letter": "C", "text": "Hypoventilation" },
        { "letter": "D", "text": "Pulmonary hypoperfusion" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        ...
        { "letter": "B", "text": "V/Q mismatch" },
        { "letter": "C", "text": "Atelectasis" },
        { "letter": "D", "text": "Rt to Lt shunt" },
        { "letter": "E", "text": "CO2 Absorbent failure" }
      ],
      "correctAnswer": "B",
    ...
    },
    {
      ...
      "options": [
        ...
        { "letter": "B", "text": "Alveolar hypoventilation" },
        { "letter": "C", "text": "Hypoxic gas mixture" },
        { "letter": "D", "text": "Carbon monoxide poisoning" }
      ],
      "correctAnswer": "B",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Alveolar hypoventilation" },
        { "letter": "B", "text": "VQ mismatch" },
        { "letter": "C", "text": "Shunt" },
        { "letter": "D", "text": "Diffusion" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Increase CO" },
        { "letter": "B", "text": "Decrease CO" },
        { "letter": "C", "text": "Increase CO2" },
        { "letter": "D", "text": "Decrease CO2" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "PO2 80, CO2 35, MAP 80, Temperature 36" },
        { "letter": "B", "text": "PO2 60, CO2 40, MAP 60, Temperature 36" },
        { "letter": "C", "text": "PO2 60, CO2 35, MAP 80, Temperature 38" },
        { "letter": "D", "text": "PO2 80, CO2 40, MAP 60, Temperature 36" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "PaO2 / FiO2 ratio" },
        { "letter": "B", "text": "Bilateral infiltrates on chest X-ray" },
        { "letter": "C", "text": "CO2 level" },
        { "letter": "D", "text": "Positive end expiratory pressure" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Keep Po2 <100mmHg" },
        { "letter": "B", "text": "Keep Pco2 > 45mmHg" },
        { "letter": "C", "text": "N2o can be used" },
        { "letter": "D", "text": "Fio2 should be 100%" },
        { "letter": "E", "text": "Hypothermia" }
      ],
      "correctAnswer": "B",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "PaO2 > 80, room air, arterial blood gas" },
        { "letter": "B", "text": "PaCO2 > 40, room air, arterial blood gas" },
        { "letter": "C", "text": "FEV1 > 2 L" },
        { "letter": "D", "text": "FEV1/FVC > 0.5" },
        { "letter": "E", "text": "Patient with predicted post-operative FEV1 (ppoFEV1) < 40 %" }
      ],
      "correctAnswer": "E",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Increase Co2 due to cessation of air flow" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Acute Peritoneal stretching" },
        { "letter": "B", "text": "Decrease venous retune" },
        { "letter": "C", "text": "Co2 embolism" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Small granules" },
        { "letter": "B", "text": "High water content" },
        { "letter": "C", "text": "High silica" },
        { "letter": "D", "text": "Strong base" }
      ],
      "correctAnswer": "D",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Reduce mortality" },
        { "letter": "B", "text": "Reduce ventilator days" },
        { "letter": "C", "text": "Increase PaO2/fiO2 ratio" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Open need active disposal" },
        { "letter": "B", "text": "Open has negative valve" },
        { "letter": "C", "text": "Close something" },
        { "letter": "D", "text": "Close" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "PaCO2 increase 50%" },
        { "letter": "B", "text": "Increase venous return" },
        { "letter": "C", "text": "Increase V/Q mismatch" },
        { "letter": "D", "text": "Increase pulmonary vascular resistance" }
      ],
      "correctAnswer": "C",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Sevo" },
        { "letter": "B", "text": "Propofol" },
        { "letter": "C", "text": "Ketamine" },
        { "letter": "D", "text": "N2O" }
      ],
      "correctAnswer": "A",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "Start chest compression" },
        { "letter": "B", "text": "Give IV adrenaline" },
        { "letter": "C", "text": "Abort the surgery and shift the Pt to ICU immediately" }
      ],
      "correctAnswer": "B",
    ...
    },
    {
      ...
      "options": [
        ...
        { "letter": "B", "text": "Rocuronium" },
        { "letter": "C", "text": "Succinylcholine" },
        { "letter": "D", "text": "Ringer Lactate" }
      ],
      "correctAnswer": "D",
    ...
    },
    {
      ...
      "options": [
        { "letter": "A", "text": "NMDA" },
        { "letter": "B", "text": "Ryanodine" },
        { "letter": "C", "text": "Potassium channel" }
      ],
      "correctAnswer": "B",
    ...
    },
    {
      ...
      "options": [
        ...
        { "letter": "B", "text": "Dantrolene" },
        { "letter": "C", "text": "Methidazole" },
        { "letter": "D", "text": "Cyproheptadine" }
      ],
      "correctAnswer": "C",
